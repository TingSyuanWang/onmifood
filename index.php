...
<html lang="en">
    ...
    <body>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDzW7mZmGbcYwb9i_q_zk5Iz60B6Opy9no"
                type="text/javascript"></script>
        <script src="resources/js/script.js"></script>
        <script src="resources/js/gmaps.js"></script>

        <!-- Global site tag (gtag.js) - Google Analytics -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-110555074-1"></script>
        <script>
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());

            gtag('config', 'UA-110555074-1');
        </script>
